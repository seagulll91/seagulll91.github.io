...
excerpt: 'Propose a novel Support-based transfer learning method for Sim2Real motion capture, namely SuDA (Support-based Domain Adaptation), which registers function supports instead of data distribution to address the data-hungry problem. _Published at ICML 2024_'
venue: 'ICML 2024'
